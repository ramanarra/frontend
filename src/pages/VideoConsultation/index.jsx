...
function VideoConsultotion({ location }) {
  ...
  useEffect(() => {
    ...
    socket.on('connect', function () {
      if (localStorage.getItem('loginUser') === 'doctor') {
        ...
        setPatientName(location.patientName)
      }
        ...
        <div>
          <div className={classes.topBar}>
            ...
            <div className={classes.chatIconHeader}>
              <img src={chatIcon} className={classes.chatIcon} onClick={handleOnChat} />
            </div>
            <div className={classes.tabIconHeader}> 
              <img src={tabIcon} className={classes.tabIcon} onClick={handleOnMedicine} />
            </div>
            </div>
          </div>
        </div>
