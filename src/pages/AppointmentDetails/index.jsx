...
import PatientAppointmentReport from './PatientAppointmentReport'
  ...
  const cancelDisable =
    appointmentDetails?.cancellationDays !== null
      ? differenceInDays.days() > Number(appointmentDetails?.cancellationDays) ||
        (differenceInDays.days() == Number(appointmentDetails?.cancellationDays) &&
          differenceInDays.hours() >
            Number(appointmentDetails?.cancellationHours)) ||
        (differenceInDays.days() == Number(appointmentDetails?.cancellationDays) &&
          differenceInDays.hours() ==
            Number(appointmentDetails?.cancellationHours) &&
      ...
      <tr>
        ...
        <td className="cell">
          <IconButton
            ...
            onClick={hanldeDelete.bind(this, data)}
          >
      ...
      {Boolean(appointmentDetails) && (
        <Box display="flex">
          <Box className={classes.doctorDetails}>
            ...
            <Box>
              <Typography className={classes.doctorName}>Dr.{doctorName}</Typography>
            ...
            <Box className={classes.sessionTiming}>
              ...
              <Typography className={classes.val}>
                {appointmentDetails.consultationTimeSlot + 'mins'}
              </Typography>
            </Box>
          ...
          <Box className={classes.appointmentDetails}>
            <Box display="flex" className={classes.details}>
              <Box>
                ...
                <Box display="flex" className={classes.nameAndValuePair}>
                  <Typography className={classes.name}>Invite Time Zone:</Typography>
                  <Typography className={classes.value} variant="h5">
              ...
              <Box className={classes.rightSide}>
                ...
                {appointmentDetails.prescriptionUrl.length ? (
                  <Box display="flex" className={classes.nameAndValuePair}>
                    ...
                    <Box display="flex" className={classes.download}>
                      <a
                        className={classes.value}
                        href={appointmentDetails.prescriptionUrl[0]}
                        target="_blank"
                ...
                {past ? (
                  ...
                  <Box>
                    <Box
                      className={classes.nameAndValuePair}
                      style={{ display: 'flex' }}
                    >
