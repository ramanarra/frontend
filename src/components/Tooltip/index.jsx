...
import { Info, Edit, DeleteOutline, ArrowBackIos, ArrowForwardIos, AddCircleOutlineTwoTone } from '@material-ui/icons'
...
export const InfoTip = (props) => {
  ...
  return (
    <span
      className={'info-tip' + (props.className ? ` ${props.className}` : '')}
    >
      <Tooltip {...props}>
