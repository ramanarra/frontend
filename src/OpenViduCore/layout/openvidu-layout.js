...
class OpenViduLayout {
 ...
 filterDisplayNone(element) {
  ...
  initLayoutContainer(container, opts) {
    this.opts = {
      maxRatio: opts.maxRatio != null ? opts.maxRatio : 3 / 4,
      minRatio: opts.minRatio != null ? opts.minRatio : 3 / 4,
      ...
      bigMaxRatio: opts.bigMaxRatio != null ? opts.bigMaxRatio : 3 / 4,
      bigMinRatio: opts.bigMinRatio != null ? opts.bigMinRatio : 3 / 4,
