...
function DoctorListWithHospital({ doctorAndHospitalList, name, isHospital, hospital }) {
  ...
  const doctorListInHospital = (key,hospitalName) => {
  ...
  return (
    <Box className={classes.container}>
      {data && <DoctorList doctorLists={data} isHospital={isHospital} />}
      {!data &&
        doctorList &&
